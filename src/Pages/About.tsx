...
const About = () => {
  ...
  return (
    <div id='about' className="relative mt-36 xl:mt-16 lg:mt-16 md:-mt-64 sm:-mt-80 xs:-mt-80 2xs:-mt-96">
      ...
      <div className="absolute inset-0 flex flex-wrap items-center justify-center text-white text-center z-10">
        <h1 className="text-5xl md:text-6xl pt-24 2xs:pt-10 font-bold bg-gradient-to-r from-green-400 to-cyan-500 bg-clip-text text-transparent">Personal <span className=''>Overview</span></h1>
        <p className="text-lg md:text-xl   pl-36 pr-36 pb-36 2xs:pl-0 2xs:pr-0 2xs:text-sm  xs:pl-6 xs:pr-6 xs:text-base sm:pl-16 sm:pr-16 md:pl-12 md:pr-12">Hello, I'm Arshan, a passionate and skilled Front-End Developer with a keen eye for design and a deep understanding of web technologies. My journey in web development has equipped me with the ability to create visually stunning and highly functional user interfaces. In addition to my front-end expertise, I have a solid grasp of core React concepts, allowing me to build dynamic and responsive web applications.
