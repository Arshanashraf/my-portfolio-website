  ...
  return (
    <div id="home" className=" text-start ">
        <Row>
            ...
            <h1 className="flex flex-wrap text-4xl font-bold relative z-50 pl-12">Greetings, I'm <span className="ml-1 relative z-50 font-extrabold text-5xl 2xl:text-6xl  md:-mt-3 bg-gradient-to-r from-green-400 to-cyan-500 bg-clip-text text-transparent">M.Arshan Ashraf</span></h1>
