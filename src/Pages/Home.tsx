  ...
  return (
    <div id="home" className=" text-start ">
        <Row>
            ...
            <h1 className="flex flex-wrap text-4xl font-bold relative z-50 pl-12">Greetings, I'm <span className="ml-1 relative z-50 font-extrabold text-5xl 2xl:text-6xl md:-mt-3 pt-1 bg-gradient-to-r from-green-400 to-cyan-500 bg-clip-text text-transparent">M.Arshan Ashraf</span></h1>
                <p className="flex flex-wrap text-lg font-semibold md:pl-20 pr-20  z-50 relative pl-14 pt-4">"Architects of the digital realm, shaping dreams into reality, one keystroke at a time."</p>
