...
function SkillLogos() {
  return (
    <div className="text-center ">
      ...
      <div className='flex flex-wrap justify-center pl-60 pr-60 gap-10 mt-10 xs:pl-10 xs:pr-10 xs:mr-5 xs:ml-16 sm:pl-28 sm:pr-16  md:pl-24 md:pr-36 lg:pl-0 lg:pr-0 xl:pl-16 xl:pr-16'>
